...
#         )
#
#         activity_3 = await activity_crud.create(
...
#         )
#
#         activity_6 = await activity_crud.create(
...
#         )
#
#         building_2 = await building_crud.create(
#             BuildingCreate(
#                 county="Kings County",
#                 region="New York",
#                 city="Brooklyn",
...
#         )
#
#         building_3 = await building_crud.create(
#             BuildingCreate(
#                 county="Cook County",
#                 region="Illinois",
#                 city="Chicago",
...
#         )
#
#         building_4 = await building_crud.create(
#             BuildingCreate(
...
#         )
#
#         phone_1 = await phone_crud.create(
#             PhoneNumberCreate(
#                 number="777 777 777",
...
#         )
#
#         phone_2 = await phone_crud.create(
#             PhoneNumberCreate(
#                 number="0 000 000 0",
